...
window.setTimeout(function(){
    ...
    if(document.getElementsByTagName('ul').length === 3){ //messenger.com without shared files
    ...
    } else if(document.getElementsByTagName('ul').length === 4){ //messenger.com with shared files
